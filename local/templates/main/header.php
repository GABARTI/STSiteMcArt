...
<div id="panel"><?$APPLICATION->ShowPanel();?></div>
  ...
  <div class="site-section bg-light">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-5" data-aos="slide" data-aos-delay="100">
        ...
        <div class="col-md-6 col-lg-4 mb-5" data-aos="slide" data-aos-delay="200">
        ...
        <div class="col-md-6 col-lg-4 mb-5" data-aos="slide" data-aos-delay="300">
